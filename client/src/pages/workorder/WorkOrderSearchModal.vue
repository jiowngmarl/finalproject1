  ...
  >
    <div class="bg-white rounded-lg w-[800px] h-[600px] flex flex-col">
      ...
      <div class="flex-1 overflow-auto p-4">
        ...
        <div
          v-else-if="workOrders.length === 0 && searchTerm"
          ...
          <div class="overflow-auto border border-gray-200 rounded">
            <table class="w-full text-sm border-collapse bg-white">
              <thead class="bg-gray-50 sticky top-0">
                <tr>
                  <th
                    class="border border-gray-200 px-3 py-2 text-left font-medium text-gray-700"
                  >
                    작업지시서 번호
                  </th>
                  <th
                  ...
                  <th
                    class="border border-gray-200 px-3 py-2 text-center font-medium text-gray-700"
                  >
                    작성일
                  </th>
                  <th
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="border border-gray-200 px-3 py-2">
                    {{ workOrder.product_summary || "제품 정보 없음" }}
                  </td>
