      ...
      >
        <table class="w-full text-xs border-collapse bg-white">
          <thead class="bg-gray-50 sticky top-0">
            <tr>
              <th
                class="border border-gray-200 px-3 py-2 text-left font-medium text-gray-700 min-w-[140px]"
              >
                작업지시번호
              </th>
              <th
...
>>>>>>> 041fb8a9dae56ed499dcd42f11dcd0ac64d0f58c
              ...
              <td class="border border-gray-200 px-3 py-2 text-center">
                <span class="font-semibold">{{
                  formatNumber(workOrder.total_qty)
                }}</span>
              </td>
              <td class="border border-gray-200 px-3 py-2 text-center">
...
const searchWorkOrders = async () => {
  ...
  try {
    ...
    const response = await axios.get(
      `/workOrder/list-page?${params.toString()}`,
    );
